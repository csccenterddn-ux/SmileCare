  ...
  return (
    <section id="about" className="scroll-mt-24 bg-white py-20 px-4 sm:px-6 lg:px-8 border-b border-[#E2E8F0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-[10px] font-sans font-extrabold tracking-widest text-[#237FE3] uppercase bg-[#F4F9FF] border border-[#BFD9FF] px-3.5 py-1.5 rounded-full inline-block mb-3 shadow-sm select-none">
            MEET YOUR DOCTOR
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 relative max-w-md mx-auto lg:max-w-none w-full">
            ...
            >
              <div className="w-8 h-8 md:w-9 md:h-9 rounded-xl bg-[#F4F9FF] text-[#237FE3] flex items-center justify-center shrink-0 shadow-sm">
            ...
            >
              <div className="w-8 h-8 md:w-9 md:h-9 rounded-xl bg-gradient-to-br from-[#0B2240]/10 to-[#237FE3]/10 text-[#237FE3] flex items-center justify-center shrink-0 shadow-sm">
                <Smile className="w-4.5 h-4.5 md:w-5 md:h-5 text-[#237FE3]" />
              </div>
              <div className="text-left leading-tight">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-[#0B2240]/5 to-[#237FE3]/5 rounded-3xl -rotate-3 translate-x-2 translate-y-3 z-0" />
          </div>
          ...
          <div className="lg:col-span-7 text-left space-y-4 sm:space-y-4">
            ...
            >
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm font-bold tracking-wide uppercase mb-3">
                  <span className="text-[#237FE3]">Implantologist & Cosmetic Dentist</span>
            ...
            >
              ...
              <motion.div 
                ...
                className="bg-[#F8FAFC]/65 border border-[#E2E8F0] rounded-2xl p-4 flex flex-col justify-between hover:shadow-md hover:border-[#237FE3]/30 transition-all duration-300 min-h-[90px]"
              >
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-7 h-7 rounded-lg bg-[#F4F9FF] text-[#237FE3] flex items-center justify-center shrink-0">
            ...
            <div className="border-t border-slate-100 pt-4">
              ...
              >
                {[
                  ...
                  >
                    <div className="w-5 h-5 rounded-full bg-[#F4F9FF] text-[#237FE3] flex items-center justify-center shrink-0">
              ...
              >
                {qualificationsList.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-10 h-10 rounded-lg bg-[#F4F9FF] text-[#237FE3] flex items-center justify-center shrink-0 shadow-sm group-hover:bg-[#237FE3] group-hover:text-white transition-all">
                        <DocIcon className="w-5 h-5" />
                      </div>
                      <div className="text-left">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-1">
                          <span className="text-[10px] font-bold text-[#237FE3] bg-[#F4F9FF] border border-[#BFD9FF] px-2.5 py-0.5 rounded-full inline-block self-start">
                            {item.year}
                          </span>
            ...
            >
              <a 
                href="#book" 
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-[#237FE3] text-white font-body font-extrabold text-sm sm:text-base hover:bg-[#69B2FF] hover:-translate-y-0.5 transition-all shadow-lg shadow-[#237FE3]/20 flex-1 text-center"
              >
